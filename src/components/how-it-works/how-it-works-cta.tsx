...
export function HowItWorksCTA({ user }: { user: LearnerProfile | null }) {
  return (
    <section aria-labelledby="final-how-cta-heading" className="section-py bg-surface/40 transition-colors">
      <div className="container-page">
        <div className="relative overflow-hidden flex flex-col items-center gap-6 rounded-container bg-gradient-to-br from-primary via-primary-700 to-indigo-950 px-6 py-12 text-center text-white shadow-lift sm:px-12 sm:py-16">
          ...
          <h2 id="final-how-cta-heading" className="heading-2 max-w-xl text-white">
            Ready to start learning?
          </h2>
          <p className="lead-text max-w-lg text-white/90 text-sm sm:text-base">
            Choose a free course or follow a guided Learning Path — no payment or prerequisites required.
          </p>
